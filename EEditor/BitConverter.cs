...
namespace EEditor
{
    ...
    public class BitConverter
    {
        ...
        ///</summary>
        public static byte[] GetBytes(bool value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///</summary>
        public static byte[] GetBytes(char value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
                return System.BitConverter.GetBytes(value);
        ...
        ///</summary>
        public static byte[] GetBytes(double value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
                return System.BitConverter.GetBytes(value);
        ...
        ///</summary>
        public static byte[] GetBytes(float value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
                return System.BitConverter.GetBytes(value);
        ...
        ///     An array of bytes with length 8.
        ///</summary>
        public static byte[] GetBytes(long value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
                return System.BitConverter.GetBytes(value);
        ...
        ///</summary>
        [CLSCompliant(false)]
        public static byte[] GetBytes(ulong value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
                return System.BitConverter.GetBytes(value);
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static short ToInt16(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static int ToInt32(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static long ToInt64(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static float ToSingle(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     value is null.
        ///</summary>
        public static string ToString(byte[] value, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static string ToString(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///</summary>
        public static string ToString(byte[] value, int startIndex, int length, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static ushort ToUInt16(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static uint ToUInt32(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static ulong ToUInt64(byte[] value, int startIndex, bool IsLittleEndian = false)
        {
            if (IsLittleEndian)
            {
